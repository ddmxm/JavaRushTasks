...
public class Solution {
    ...
    public static void main(String[] args) {PrintStream consoleStream = System.out; //запоминаем настоящий PrintStream в специальную переменную
        ...
        System.out.println(result.replaceAll("\\D", "")); //выводим строку на консоль с заменой по регулярному выражению
    }
